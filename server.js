...
const uri = "mongodb+srv://acdesveaux:acdesveaux@webwarea3.2jccd.mongodb.net/webwarea3?retryWrites=true&w=majority";
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
let collection = null;
client.connect()
    .then(() => client.db("WebwareA3").collection("data"))
    .then(__collection => {
...
passport.use(new LocalStrategy(
    function (username, userPassword, done) {
        const userColl = client.db("WebwareA3").collection("users");
